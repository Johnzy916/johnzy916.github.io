...
},{"./components/hero.js":"5XWAP","./components/projects":"cKH1t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5XWAP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"cKH1t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _mixitup = require("mixitup");
var _mixitupDefault = parcelHelpers.interopDefault(_mixitup);
exports.default = async ()=>{
    const mixer = _mixitupDefault.default('.project-grid', {
        selectors: {
            target: '.project-card'
        }
    });
...
},{"mixitup":"apx9j","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"apx9j":[function(require,module,exports) {
/**!
 * MixItUp v3.3.1
 ...
 */ (function(window) {
    ...
    (function() {
        var VENDORS = [
            ...
            'o',
            'ms'
        ], canary = window.document.createElement('div'), i1 = -1;
        // window.requestAnimationFrame
        for(i1 = 0; i1 < VENDORS.length && !window.requestAnimationFrame; i1++)window.requestAnimationFrame = window[VENDORS[i1] + 'RequestAnimationFrame'];
     ...
     */ h = {
         ...
         */ defer: function(libraries) {
            ...
            } else if (window.console) // No implementation
         ...
         * @return  {*} value
         */ getProperty: function(obj1, stringKey) {
            var parts = stringKey.split('.'), returnCurrent = null, current = '', i = 0;
            if (!stringKey) return obj1;
            ...
            while(i < parts.length){
                current = parts[i];
                obj1 = returnCurrent(obj1);
                i++;
            }
            if (typeof obj1 !== 'undefined') return obj1;
            else return null;
        }
    };
    mixitup.h = h;
    ...
    h.extend(mixitup.Control.prototype, /** @lends mixitup.Control */ {
         ...
         */ handleClick: function(e) {
            var self = this, button = null, mixer = null, isActive = false, returnValue = void 0, command = {
            }, clone = null, commands = [], i = -1;
    ...
    h.extend(mixitup.Mixer.prototype, /** @lends mixitup.Mixer */ {
         ...
         */ getStartMixData: function(operation) {
            var self = this, parentStyle = window.getComputedStyle(self.dom.parent), parentRect = self.dom.parent.getBoundingClientRect(), target = null, data = {
            }, i = -1, boxSizing = parentStyle[mixitup.features.boxSizingProp];
         ...
         */ diffDatasets: function(operation) {
            var self = this, persistantStartIds = [], persistantNewIds = [], insertedTargets = [], data = null, target = null, el = null, frag = null, nextEl = null, uids = {
            }, id = '', i = -1;
    ...
    h.extend(mixitup.Target.prototype, {
         ...
         */ getPosData: function(getBox) {
            ...
            }, rect = null, posData = new mixitup.StyleData();
